...
print('-' * 51)
print(f'Закончили курс                |{c:^10}|{c / i:^8.2%}|')
print(f'Допущено к экзамену           |{b:^10}|{b / i:^8.2%}|')
print(f'Выполнено заданий от 1 до 9   |{d:^10}|{d / i:^8.2%}|')
print(f'Не выполнено ни одного задания|{a:^10}|{a / i:^8.2%}|')
print('-' * 51)
print(f'Общее количество              |{c+b+d+a:^10}|{(c+b+d+a)/i:^8.0%}|')
print('-' * 51)
